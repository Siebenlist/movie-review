    ...
    <section className="mt-10">
      <div className="w-full flex flex-col justify-center items-center mb-10">
        <Image
          ...
          width={150}
          height={1}
          className="border border-gray p-[1px] rounded-sm"
        />
        ...
        <p>
          ...
          <span className="inline-flex items-center">
            4.3/5{" "}
            <img src={reviewStar.src} alt="Review star" className="w-[15px]" />
          </span>
        </p>
        <MovieActions />
      </div>
      <article className="p-3">
        <p>
          ...
          eget mollis. Class aptent taciti sociosqu ad litora torquent per
          conubia nostra, per inceptos himenaeos. Etiam ultrices, justo quis
          venenatis scelerisque, erat massa aliquam diam, in scelerisque felis
          augue sed quam. In hac habitasse platea dictumst. Integer ut
